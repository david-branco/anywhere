<div class ="container">   
    ...
    <?php        
        ...
        echo form_open_multipart(base_url() ."index.php/evento/formClass/$id_disciplina/$id_evento", $attributes);        
        ...
        $attributes = array('class' => 'btn btn-primary', 'name' => "editEventClass", 'value' => 'Save ' .$title);
