<div class ="container">
    ...
    <?php
        ...
        echo form_open(base_url() ."index.php/contacto/emailDocentes/".$id_trabalho, $attributes);        
        ...
        $attributes = array('class' => 'btn btn-primary btn-sm', 'name' => "contactDocentes", 'value' => 'Send Email');
