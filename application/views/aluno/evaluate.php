<div class ="container">  
    ...
    <?php        
        ...
        echo form_open_multipart(base_url() ."index.php/aluno/evaluate/$id_aluno/$id_trabalho", $attributes);        
        ...
        $data = array(
            ...
            "placeholder" => "Evaluate the Work Member"
        );
        ...
        $attributes = array('class' => 'btn btn-success', 'name' => "evaluateAluno", 'value' => 'Evaluate');
