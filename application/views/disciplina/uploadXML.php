<div class ="container">
    ...
    <?php        
        ...
        echo form_open_multipart(base_url() ."index.php/disciplina/uploadXML/$id_disciplina", $attributes); 
        ...
        $attributes = array('class' => 'btn btn-primary', 'name' => "upFichXMLdisc", 'value' => 'Save File');
