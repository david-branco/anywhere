    <a class="navbar-brand" href="<?php echo base_url();?>index.php/frontend/docente">Anywhere</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url()."index.php/docente/profile/".$this->session->userdata("id")?>">Show Profile</a></li>
            <li><a href="<?php echo base_url()."index.php/docente/form/".$this->session->userdata("id")?>">Edit Profile</a></li>
          </ul>
        </li>
        <li class="dropdown">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo base_url()."index.php/trabalho/showList/".$this->session->userdata("id")?>">Show Works</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url()."index.php/docente/showAlunos/".$this->session->userdata("id")?>">Show Students</a></li>
          </ul>
        </li>
        <li class="dropdown">
