<div class ="container">
    ...
    <?php
        ...
        echo form_open_multipart(base_url() ."index.php/docente/form/$docente_id", $attributes);        
        ...
        $attributes = array('class' => 'btn btn-primary', 'name' => "updDocenteSubmit", 'value' => 'Save ' .$title);
